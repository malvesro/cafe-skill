...
REGIOES = {
    ...
    "mantiqueira":        "⛰️ Mantiqueira, MG",
    "chapada_diamantina": "💎 Chapada Diamantina, BA",
    "matas_de_minas":     "🌳 Matas de Minas, MG",
    "alta_mogiana":       "☕ Alta Mogiana, SP",
    "amazonico":          "🛶 Robusta Amazônico, RO",
